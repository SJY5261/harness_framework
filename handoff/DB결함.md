...
_최종 상태: 2026-08-03 코드 학습 가이드 HTML에서 좌측 목차를 제거하고 테마·인쇄 도구는 상단에 유지했다. 원격 브랜치·제품 diff·라이브 DB·테스트는 2026-07-31 재검토 상태를 유지한다. 별도 코드 이해 리뷰는 사용자 판단에 따라 폐기했다. 긴 진행 이력은 [역사 보존본](../logs/handoff/DB결함_2026-07-28_history.md)에 있다._
...
- 새 코드 학습 가이드는 MD 1,418줄이며 MD·HTML의 제목 87개·표 24개·코드 블록 35개·접기 영역 5개가 일치한다. 2026-08-03 변경 후 HTML의 좌측 목차 요소·잔여 참조 0개, 상단 도구 모음 1개, 외부 의존성 0, UTF-8 BOM 없음과 MD SHA-256 불변을 확인했다. Edge headless 렌더링도 종료 코드 0, 제목·본문·상단 도구 표시, 목차 미표시, 오류 신호 0으로 통과했다.
